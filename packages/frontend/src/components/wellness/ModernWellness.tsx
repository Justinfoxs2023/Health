...
export const ModernWellness: React.FC<Props> = ({
  userId,
  userProfile
}) => {
  ...
  const renderProgramCard = (program: TherapyProgram) => (
    <Card key={program.id} style={styles.programCard}>
      <View style={styles.cardHeader}>
        <View style={styles.headerLeft}>
          <Icon 
            name={getProgramIcon(program.category)} 
            size={24} 
            color="#2E7D32" 
          />
          <View>
        ...
        <View style={styles.professionalInfo}>
          <View style={styles.professionalHeader}>
            <Text style={styles.professionalName}>
              {program.professional.name}
            </Text>
            <Text style={styles.professionalTitle}>
              {program.professional.title}
            </Text>
          </View>
