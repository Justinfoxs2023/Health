...
export const ExerciseGoalSettingScreen = ({ navigation }) => {
  const { data: currentGoals, isLoading } = useQuery<IExerciseGoals>(
    'exerciseGoals',
    getExerciseGoals,
  );
  const [form, setForm] = React.useState<IExerciseGoals>({
    weeklyFrequency: 3,
    weeklyDuration: 150,
    weeklyCalories: 1500,
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerDesc}>设定合理的运动目标，我们将为您制定个性化的运动计划</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <FormInput
          ...
          onChangeText={value =>
            setForm(prev => ({ ...prev, weeklyFrequency: parseInt(value) || 0 }))
          }
        ...
        <FormInput
          ...
          onChangeText={value =>
            setForm(prev => ({ ...prev, weeklyDuration: parseInt(value) || 0 }))
          }
          keyboardType="number-pad"
        ...
        <FormInput
          ...
          onChangeText={value =>
            setForm(prev => ({ ...prev, weeklyCalories: parseInt(value) || 0 }))
          }
          keyboardType="number-pad"
