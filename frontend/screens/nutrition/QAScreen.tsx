...
export const QAScreen = () => {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useQuery(['nutritionQuestions', { category, keyword }], () =>
  ...
  return (
    <View style={styles.container}>
      <SearchBar value={keyword} onChangeText={setKeyword} placeholder="搜索营养咨询问题..." />
      <CategoryFilter categories={categories} selectedCategory={category} onSelect={setCategory} />
      {isLoading ? (
        <LoadingSpinner />
      ) : (
        <FlatList
      ...
      <TouchableOpacity style={styles.askButton} onPress={() => navigation.navigate('AskQuestion')}>
