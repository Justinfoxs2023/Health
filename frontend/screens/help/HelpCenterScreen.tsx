...
export const HelpCenterScreen = ({ navigation }) => {
  const { data: categories, isLoading } = useQuery<HelpCategory[]>('helpCategories', getHelpCategories);
        ...
        <View style={styles.categoryGrid}>
          {categories?.map((category) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('HelpCategory', { id: category.id, name: category.name })}
            >
