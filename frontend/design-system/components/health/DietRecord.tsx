...
export const DietRecord: React.FC<IDietRecordProps> = ({
  mealType,
  time,
  foods,
  totalCalories,
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <View style={styles.mealInfo}>
          <CustomIcon name={getMealIcon()} size={24} color={DesignTokens.colors.brand.primary} />
      ...
      {imageUrl && <Image source={{ uri: imageUrl }} style={styles.mealImage} resizeMode="cover" />}
