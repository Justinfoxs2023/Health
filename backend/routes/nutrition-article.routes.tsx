...
// 创建文章
router.post('/', auth.nutritionistRequired, upload.single('coverImage'), nutritionArticleController.createArticle);
...
// 更新文章
router.put('/:id', auth.nutritionistRequired, upload.single('coverImage'), nutritionArticleController.updateArticle);
