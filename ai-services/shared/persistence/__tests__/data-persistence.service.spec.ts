...
describe('DataPersistenceService', () => {
  ...
  describe('健康数据持久化', () => {
    ...
    it('应该能够批量保存健康数据', async () => {
      const testDataList: IHealthData[] = Array(5)
        .fill(null)
        .map((_, index) => ({
    ...
    it('应该能够按时间范围查询健康数据', async () => {
      ...
      const testDataList: IHealthData[] = Array(10)
        .fill(null)
        .map((_, index) => ({
          userId,
  ...
  describe('数据清理', () => {
    it('应该能够清理过期数据', async () => {
      // 准备测试数据
      const userId = 'test-user';
      const oldData: IHealthData[] = Array(5)
        .fill(null)
        .map((_, index) => ({
          userId,
      ...
      const newData: IHealthData[] = Array(5)
        .fill(null)
        .map((_, index) => ({
          userId,
  ...
  describe('数据统计', () => {
    it('应该能够获取数据统计信息', async () => {
      // 准备测试数据
      const healthData: IHealthData[] = Array(10)
        .fill(null)
        .map((_, index) => ({
